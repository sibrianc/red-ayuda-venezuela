...
| S-003 | [ReliefWeb API](https://apidoc.reliefweb.int/endpoints), OCHA | Informes curados, fuentes y cronología | API oficial; consultar 60 min | Metadatos P0; texto/hechos quedan R1; exige `appname` preaprobado | **Diferida por presupuesto.** No pedir `appname` hasta contar con dominio/correo oficial y nueva aprobación. |
