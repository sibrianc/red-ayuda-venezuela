...
> Revisión: 2026-06-28. Estado de la fase: **inventario técnico completo; ninguna
> fuente activada**. Este documento no autoriza contacto, autenticación, descarga,
> scraping, cron ni publicación. Los estados se rigen por `data-governance.md`.
...
|---|---|---|---|---|---|
| S-001 | [USGS Earthquake Hazards Program](https://earthquake.usgs.gov/earthquakes/feed/v1.0/geojson.php) | Evento, magnitud, profundidad, hora y geometría sísmica | GeoJSON oficial; 1–5 min | P0; revisar términos y atribución | **En evaluación.** Contexto sísmico, nunca conteo de personas. Primera candidata oficial para staging. |
| S-002 | [GDACS](https://www.gdacs.org/feed_reference.aspx), ONU/Comisión Europea | Alertas, severidad y metadatos de desastre | Feed oficial; origen se actualiza aprox. cada 6 min; consultar 10–15 min | P0; atribución obligatoria | **En evaluación.** Complementa, no sustituye autoridades nacionales. |
| S-003 | [ReliefWeb API](https://apidoc.reliefweb.int/endpoints), OCHA | Informes curados, fuentes y cronología | API oficial; consultar 60 min | Metadatos P0; texto y hechos extraídos quedan R1 hasta revisión | **En evaluación.** No usar endpoints v0 ni publicar extracción automática. |
...
- [ ] Una fuente oficial ratificada por el propietario para staging.
- [ ] Una fuente de socio con permiso verificable lista para staging.
