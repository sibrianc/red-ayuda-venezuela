...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "Desaparecidas y localizadas — publicadas por fuentes identificadas. Menores excluidos por protección.": "Missing and found — published by identified sources. Minors excluded for protection.",
        "Desaparecidas y localizadas. Busca o reporta a un familiar.": "Missing and found. Search for or report a relative.",
        "Por respeto a las familias y para no arriesgar errores, no publicamos una lista de nombres de personas fallecidas. La identificación corresponde a las autoridades y a los registros oficiales.": "Out of respect for families and to avoid errors, we do not publish a list of names of deceased people. Identification is the responsibility of the authorities and official registries.",
        "Para datos de personas fallecidas, consulta a las autoridades y los registros oficiales de abajo.": "For information on deceased people, consult the authorities and the official registries below.",
        "En memoria de las personas fallecidas": "In memory of those who have died",
        "Acompañamos en el dolor a cada familia que ha perdido a un ser querido. Ninguna cifra alcanza a nombrar lo que vale una vida: sostenemos su memoria con respeto, y a ustedes, con fuerza. No están solos.": "We stand with every family grieving a loved one. No number can ever name what a life is worth: we hold their memory with respect, and we hold you with strength. You are not alone.",
        "Si buscas a una persona fallecida o necesitas confirmar una identificación, el registro oficial reúne y actualiza esa información con el debido cuidado.": "If you are searching for a person who has died or need to confirm an identification, the official registry gathers and updates that information with due care.",
        "Consultar el registro oficial": "Consult the official registry",
        "Panorama humanitario público del terremoto de Venezuela: mapa de servicios (hospitales, refugios, agua, combustible), edificios y daños, personas y coordinación de rescate — cada dato con su fuente.": "Public humanitarian overview of the Venezuela earthquake: a map of services (hospitals, shelters, water, fuel), buildings and damage, people and rescue coordination — each item with its source.",
        "Directorio del terremoto de Venezuela: personas, edificios e incidentes, servicios, zonas sin comunicación y mascotas — cada dato con su fuente.": "Venezuela earthquake directory: people, buildings and incidents, services, areas without communication and pets — each item with its source.",
        "Personas desaparecidas y localizadas tras el terremoto de Venezuela. Busca o reporta a un familiar en el registro ciudadano oficial.": "People missing and found after the Venezuela earthquake. Search for or report a relative in the official citizen registry.",
        "Edificios colapsados y evaluación estructural tras el terremoto de Venezuela, con fuente verificada.": "Collapsed buildings and structural assessment after the Venezuela earthquake, with verified sources.",
        "Hospitales, refugios, agua, farmacias, combustible y víveres disponibles tras el terremoto de Venezuela.": "Hospitals, shelters, water, pharmacies, fuel and supplies available after the Venezuela earthquake.",
        "Zonas sin comunicación tras el terremoto de Venezuela: alertas de posibles víctimas incomunicadas.": "Areas without communication after the Venezuela earthquake: alerts about possible isolated victims.",
        "Mascotas perdidas tras el terremoto de Venezuela: reportes de la comunidad y fuentes verificadas.": "Pets lost after the Venezuela earthquake: community reports and verified sources.",
        "Centro de coordinación del terremoto de Venezuela: prioridades de rescate y enlace entre familias, rescatistas y recursos.": "Venezuela earthquake coordination center: rescue priorities linking families, rescuers and resources.",
        "Teléfonos y contactos de emergencia en Venezuela: 911, instituciones de rescate y colectivos de búsqueda.": "Emergency phones and contacts in Venezuela: 911, rescue institutions and search collectives.",
        "Reconocimiento a las unidades de rescate y los perros que ayudaron tras el terremoto de Venezuela.": "Recognition of the rescue units and dogs that helped after the Venezuela earthquake.",
        "Privacidad y uso responsable de los datos en Red de Ayuda Venezuela.": "Privacy and responsible use of data at Red de Ayuda Venezuela.",
        "Compartir": "Share",
        ...
        "Ayuda a difundir": "Help spread the word",
        "Mapa, servicios, personas y coordinación del terremoto de Venezuela, en un solo lugar:": "Map, services, people and coordination of the Venezuela earthquake, all in one place:",
        "Directorio del terremoto de Venezuela: personas, servicios, edificios y coordinación.": "Venezuela earthquake directory: people, services, buildings and coordination.",
        "Fallecidas": "Deceased",
        "En memoria": "In memoriam",
        "Honramos la memoria de las víctimas": "We honor the memory of the victims",
        "personas fallecidas reportadas oficialmente": "people officially reported deceased",
        "Búsqueda y confirmación de identificaciones": "Search and confirmation of identifications",
        ...
        "Registro de personas desaparecidas": "Missing persons registry",
        "¿Buscás o reportás a un familiar desaparecido?": "Looking for or reporting a missing relative?",
        "El registro de personas lo gestiona el registro ciudadano oficial. Nosotros concentramos el mapa de servicios, los daños y la coordinación: no duplicamos su trabajo, lo complementamos.": "The persons registry is run by the official citizen registry. We gather the services map, damage and coordination: we don't duplicate their work, we complement it.",
        "Concentramos y presentamos el panorama del terremoto: mapa de servicios (hospitales, refugios, agua, combustible), edificios y daños, zonas sin comunicación y coordinación de rescate — cada dato con su fuente. ¿Buscás o reportás a un familiar desaparecido? Te llevamos al registro ciudadano oficial.": "We gather and present the earthquake picture: a services map (hospitals, shelters, water, fuel), buildings and damage, areas without communication and rescue coordination — each item with its source. Looking for or reporting a missing relative? We take you to the official citizen registry.",
        "Localizadas y desaparecidas, de fuentes públicas. Para reportar, usá el registro oficial.": "Found and missing, from public sources. To report, use the official registry.",
        "Fuentes": "Sources",
        "Reportar y buscar": "Report & search",
        "Reportar un problema": "Report an issue",
        "Sugerencias y contribuir": "Suggestions & contribute",
        "Código abierto (MIT)": "Open source (MIT)",
        "Desarrollado por": "Built by",
        "No es un servicio oficial de emergencia": "Not an official emergency service",
        "Concentramos y presentamos información dispersa del terremoto de Venezuela. No es un servicio oficial de emergencia: ante peligro inmediato marca el 9-1-1.": "We gather and present scattered information about Venezuela's earthquake. This is not an official emergency service: in immediate danger call 9-1-1.",
        "Datos de fuentes públicas y verificadas (USGS, GDACS, OpenStreetMap, ONU/OCHA y prensa), con atribución. La ausencia de registros no significa ausencia de daño.": "Data from public, verified sources (USGS, GDACS, OpenStreetMap, UN/OCHA and press), with attribution. Absence of records does not mean absence of harm.",
        ...
        "Se gestiona en el registro ciudadano de personas desaparecidas.": "Handled at the citizen registry for missing persons.",
        "Ir al registro →": "Go to the registry →",
